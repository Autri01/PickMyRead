...
import com.nashapp.epublibdroid.EpubReaderView;
...
public class ReadingActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        stop_read = (ImageView) findViewById(R.id.stop_read);
        ...
        read_aloud.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String str = Jsoup.parse(ePubReader.GetChapterContent()).text();

                ttsPlayer.speak(str, TextToSpeech.QUEUE_FLUSH, null);
            }
        });
                ...
                handler.postDelayed(new Runnable() {
                    ...
                    public void run() {
                        ...
                        if(ChapterNumber>=0&&!SelectedText.equals("")&&!DataString.equals("")) {
                            ttsPlayer.speak(SelectedText, TextToSpeech.QUEUE_FLUSH, null);
                        }
